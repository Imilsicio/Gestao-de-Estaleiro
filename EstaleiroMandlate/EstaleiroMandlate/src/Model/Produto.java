...
public class Produto {
    ...
    public Produto(int id, int NrSerie, String nome, boolean estado, String descricao, String forncedor) {
        this.id = id;
    ...
    public Produto(int NrSerie, String nome, boolean estado, String descricao, String forncedor) {
        this.NrSerie = NrSerie;
        this.nome = nome;
        this.estado = estado;
        this.descricao = descricao;
