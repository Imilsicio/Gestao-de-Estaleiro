...
public class ProdutoController {
     ...
     public void registar(Produto produto) {
        {
            ...
            String sql = "INSERT INTO produto( nrserie,nome, estado,descricao,fornecedor) VALUES (?,?,?,?,?)";
            try (PreparedStatement stm = dataBase.prepareStatement(sql)) {
                ...
                stm.setString(5, produto.getForncedor());
    ...
    public void atualizar(Produto produto) {
        ...
        if (!String.valueOf(produto.getId()).isEmpty()) {
            String sql = "UPDATE  produto SET nrserie=?,nome=?,estado=?,descricao=?,fornecedor=? WHERE produto.id=?";
